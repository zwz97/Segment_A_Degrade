...
from pipeline_utils import (
    load_sam2_predictor_and_generator,
    predict_auto_mask, 
...
def run_evaluation_pipeline(config: dict):
    ...
    Loads pre-processed data using load_sam2_evaluation_data.
    Evaluates the best matching SAM2 prediction against the single GT mask for each image version.
    ...
    if not all([model_hf_id, data_path, image_base_dir]):
...
if __name__ == "__main__":
    ...
    run_evaluation_pipeline wiring without downloading a SAM2 model. It
    ...
    def _stub_load_sam2_predictor_and_generator(model_hf_id: str, generator_config: dict):
    ...
    load_sam2_predictor_and_generator = _stub_load_sam2_predictor_and_generator  # type: ignore
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        cfg = {
            "model_hf_id": "stub-model",  # arbitrary placeholder
        ...
        print("\n>>> Running sam2_eval_pipeline smoke test …")
